        ...
        <>
            <section className={styles.take__action} id="take_action">
                <div className="container">
                    <h2 className={styles.take__action_title}>Participate online</h2>
                    <div className={styles.take__action_description}>
                        <p>Want to proudly tell your grandchildren you fought for freedom
                            in the world's first online war? Here are some quick and easy actions you can take from home
                            to help fight for justice and peace.</p>
                    </div>
                    <div className={styles.take__action_box}>
                        ...
                        <div className={styles.take__action_item}>
                            ...
                            <div className={styles.take__action_example}
                                ...
                                <p className={styles.example_link}>
                                    <a href=""
                                    ...
                                    <div className={styles.take__action_social}
                                        ...
                                        <svg width="36" height="25" viewBox="0 0 36 25" fill="none"
                                            ...
                                            <g clipPath="url(#clip0_301_2)">
                                                <path
                                                    d="M34.8679 3.96236C34.4558 2.43858 33.2672 1.24538 31.7434 0.83783C29.6966 0.0476413 9.87169 -0.339529 4.12074 0.860471C2.59697 1.27255 1.40376 2.46123 0.996215 3.985C0.0724415 8.03783 0.00225279 16.8001 1.01886 20.9435C1.43093 22.4673 2.61961 23.6605 4.14339 24.068C8.19622 25.0008 27.4641 25.1322 31.766 24.068C33.2898 23.6559 34.483 22.4673 34.8906 20.9435C35.8755 16.5284 35.9457 8.30953 34.8679 3.96236Z"
                                                    fill="#FF0000"/>
                                                <path d="M23.7736 12.4529L14.5359 7.15479V17.751L23.7736 12.4529Z"
                                                      fill="white"/>
                                            </g>
                                            <defs>
                                                <clipPath id="clip0_301_2">
                                                    <rect width="36" height="24.9057" fill="white"/>
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    </div>
            ...
            <div className={`popup ${popup === true ? 'active' : ''}`}>
                <div className="popup__wrap">
                    ...
                    <div className="popup__info">
                        <div className={styles.take__action_info}>
                            <div className={styles.take__action_info_box}>
                                ...
                                <a href="https://www.youtube.com/" target="_blank" className="button button__blue"
