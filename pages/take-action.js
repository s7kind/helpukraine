                    ...
                    <div className={styles.container}>
                        ...
                        <div className={action.take__action_box}>
                            <div className={action.take__action_item}>
                                ...
                                <div className={action.take__action_example}>
                                    <p className={action.example_link}>
                                        <a onClick={(event) => handlePopup(event, 'Russia invaded Ukraine and Russian troops are shooting civilians. Russian soldier activate vacuum bombs and utilize carpet bombing tactics in residential areas. They do not allow green corridors and shell trucks that are carrying humanitarian aid.')}
                                           href="#">Example Message [EN]</a>
                                    </p>
                                    <p className={action.example_link}><a
                                        onClick={(event) => handlePopup(event, 'Россия начала войну в Украине, и российские войска расстреливают мирных жителей. Русские солдаты используют тактику ковровой бомбардировки жилых районах. Они мешают созданию зеленых коридоры и обстреливают грузовики с гуманитарной помощью.')}
                            ...
                            <div className={action.take__action_item}>
                                ...
                                <p className={styles.main__section_act__text}>Go to one of these websites: barahla.net,
                                    Avito.ru, Tiu.ru, dmir.ru.
                                    Create an account and advertise a product: TV, washing machine, car, get
                                    creative!... For the product picture, use one of the photos at this link
                                    (<a href="https://drive.google.com/drive/folders/19PoE_TMoxwcCARXl9BHWcjaN__MdUOu5"
                                        target="_blank">link to photo album</a>)
                                </p>
                                <div className={action.take__action_example}>
                                    <p className={action.example_link}><a
                                        onClick={(event) => handlePopup(event, 'Russian soldiers have killed over 350 civilians in the first nine days of the Russian invasion of Ukraine. They used indiscriminate weapons and destroyed the critical infrastructure of the cities. ')}
                                        href="#">Example Message [EN]</a></p>
                                    <p className={action.example_link}><a
                                        onClick={(event) => handlePopup(event, 'Российские солдаты убили более 350 мирных жителей за первые девять дней вторжения в Украину. Они применяли неизбирательное оружие и уничтожали фундаментальную инфраструктуру городов.')}
                                        href="#">Example message [RU]</a></p>
                                </div>
                            </div>
                            ...
                            <div className={action.take__action_item}>
                                <div className={styles.main__section_act__take__action_social}>
                                    ...
                                    {/*    </svg>*/}
                                    {/*</a>*/}
                                    <img src="/take-action/squad303.png" alt="" width="100"/>

                                </div>
                                <h3>Send Russians SMS about the war!</h3>
                                <p className={styles.main__section_act__text}>Anonymous group has created a tool that
                                    enables anyone to bypass the Kremlin's draconian info blackout & text random people
                                    in Russia about what is going on in Ukraine. <a href="http://1920.in">This is it</a>
                                </p>
                                <div className={action.take__action_example}>
                                    <p>
                                        <span>For Mobile: </span>Go to the page, hit the send button and it automatically
                                        populates an SMS in Russian to a random Russian number. Then click send and
                                        you’ve helped in the information war with Russia!
                                    </p>
                                </div>
                                <div className={action.take__action_example}>
                                    <p>
                                        <span>For Desktop: </span>
                                        Access the website and obtain random numbers (of real people).
                                        Copy paste the suggested Russian text provided on their website.
                                        Send as an SMS
                                    </p>
                                </div>
                                <div className={action.take__action_example}>
                                    <p className={action.example_link}><a
                                        onClick={(event) => handlePopup(event, 'Russian troops are committing crimes against humanity, democracy, and peace in Ukraine. They have killed more than 350 civilians, including women and children in the first 9 days of the war.')}
                                        href="#">Example Message [EN]</a></p>
                                    <p className={action.example_link}><a
                                        onClick={(event) => handlePopup(event, 'Российские войска совершают преступления против человечества, демократии и мира. За первые 9 дней войны они убили более 350 мирных жителей, в том числе женщин и детей. ')}
                                        href="#">Example message [RU]</a></p>
                                </div>
                            ...
                            <div className={action.take__action_item}>
                                ...
                                <div className={action.take__action_example}>
                                    <p className={action.example_link}><a
                                        onClick={(event) => handlePopup(event, 'Russia invaded Ukraine and Russian troops are shooting civilians. Russian soldiershey activate vacuum bombs and utilize carpet bombimg tactics in residential areas. They do not allow green corridors and shell trucks that are carrying humanitarian aid.')}
                                        href="#">Example Message [EN]</a></p>
                                    <p className={action.example_link}><a
                                        onClick={(event) => handlePopup(event, ' Россия начала войну в Украине, и российские войска расстреливают мирных жителей. Русские солдаты используют тактику ковровой бомбардировки жилых районах. Они мешают созданию зеленых коридоры и обстреливают грузовики с гуманитарной помощью.')}
                                        href="#">Example message [RU]</a></p>
